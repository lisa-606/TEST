...
@Desc:
"""
from doubleSpellingApplication.Stimulation_Operation.CommonSystem.MessageReceiver.EEGPlatformCommunicationModule.interface.CommunicationConsumerInterface import CommunicationConsumerInterface
