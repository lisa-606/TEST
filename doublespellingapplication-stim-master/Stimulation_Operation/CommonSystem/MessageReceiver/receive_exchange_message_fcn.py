import time
from doubleSpellingApplication.Stimulation_Operation.CommonSystem.MessageReceiver.EEGPlatformCommunicationModule.exception.Exceptions import TopicNotAvailableException
import logging
    ...
    try:
        ...
        while True:
            ...
            if consumeMsg:
                ...
                logger.debug('receive: ' + str(consumeMsg, encoding='utf-8'))
            # else:
