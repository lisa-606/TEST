...
from MessageQueue.implement.CommunicationConsumer import CommunicationConsumer
...
if __name__ == '__main__':
    ...
    confPath = r"/python_project/ReceiverOperation/MessageQueue/usage/config/consumer-config.json"
    # 收信topic名
    topic = "py-test-topic1-drh"
